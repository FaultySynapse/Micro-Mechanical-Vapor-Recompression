...
def main() -> None:
    ...
    print(f"  temperature lift .... {params.temp_lift:.2f} K")
    ...
    print(f"  fan flow ............ {params.fan_volumetric_flow*1000:.1f} L/s")
    print()
    print("Performance")
    print(f"  PRODUCTION .......... {r.distillate_lph:.2f} L/h")
    print(f"  fan power ........... {r.fan_power:.0f} W")
    print(f"  auxiliary heating ... {max(r.makeup_heat, 0.0):.0f} W "
          f"(makeup {r.makeup_heat:.0f} W)")
    print(f"  total power ......... {r.total_energy_input:.0f} W")
